...
// 	.catch(err => console.error(err));
  ...
  fetch('https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?query=tomato', options)
	.then(response => response.json())
	.then(response => console.log(response))
	.catch(err => console.error(err));


  //like the weather dashboard
  //input area to type in user info
  //then pass in user info to api within an event listener with a click button